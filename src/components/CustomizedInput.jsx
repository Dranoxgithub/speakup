...
const PODCAST_LENGTH = [
  { name: "short_podcast_length", title: "Short teaser (up to 5 minutes)" },
  { name: "medium_podcast_length", title: "Everday podcast (15 - 20 minutes)" },
];
  ...
  return (
    <div className="customizedInputContainer">
      ...
      <div className="customizedInputBlock">
        ...
        <label for="podcast_overall_length" />

        <select
          name="podcast_overall_length"
          id="podcast_overall_length"
          onChange={(e) => props.setPodcastLength(e.target.value)}
        >
          {PODCAST_LENGTH.map((item, index) => (
