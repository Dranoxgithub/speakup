  ...
  return (
    <div className="customizedInputContainer">
      ...
      <div className="customizedInputBlock">
        <h4 className="customizedInputField">Podcast Title: </h4>
        <input
          type="text"
      ...
      <div className="customizedInputBlock">
        <h4 className="customizedInputField">Host Name: </h4>
        <input
          type="text"
          placeholder="Zuzu"
      ...
      <div className="customizedInputBlock">
        <h4 className="customizedInputField" style={{ marginBottom: "0px" }}>
          Estimated Length:{" "}
        </h4>
        <p className="customizedInput" style={{ marginBottom: "0px" }}>
          {props.totalLength} minutes
        </p>
      </div>
      ...
      <div className="customizedInputBlock">
        <h4 className="customizedInputField">Ad: </h4>
        <input
          type="text"
